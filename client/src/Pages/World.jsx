    ...
    return (
        <a-scene loading-screen="dotsColor: red; backgroundColor: #010000">
            {/*
              ...
              The world now loads its own assets out of client/public.

              There is deliberately no <a-asset-item> here. A-Frame 1.0.4 waits
              on those forever if one fails to load — its three second asset
              timeout does not rescue a rejected fetch — and a single dead URL
              leaves the whole world stuck on the loading screen. Textures and
              fonts are referenced directly instead, so a missing one costs a
              texture rather than the entire scene.
            */}
            <a-assets>
